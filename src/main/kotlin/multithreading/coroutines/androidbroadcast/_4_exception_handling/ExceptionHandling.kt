 ...
 *     }
 *
 * Все необработанные исключения будут доставляться родительской корутине или скоупу, и приводить к крашу, если не обработать. //TODO: Протестить как пробрасываются исключения в Structured Concurrency
