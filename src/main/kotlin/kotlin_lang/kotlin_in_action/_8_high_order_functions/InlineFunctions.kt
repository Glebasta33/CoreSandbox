...
fun main() {
     ...
     * Соответсвующее параметры inline-функции следует помечать noinline (невстраиваемый). //TODO Реализовать кейс с noinline, как это связано с нелокальным возвратом?
     *
