...
fun main() {
     ...
     *
     * Ключевое слово "return" в лямбда-выражении производит выход их функции, в которой вызывается это лямбда-выражение,
     * а не из него самого. То есть инструкция "return" производит нелокальный возврат, потому что возвращает результат
     * из внешнего блока, а не из блока, содержащего "return".
     *
     * В данном примере "return" выходит из lookForAliceLambda, а не из лямбды for.
     *
